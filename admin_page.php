...
if(isset($_GET['delete'])){
    $id = $_GET['delete'];
    mysqli_query($conn,"DELETE FROM pocket_doctor WHERE id =$id");
...
<body>
    ...
    ?>
        ...
        <?php 
            $select =mysqli_query($conn,"SELECT * FROM pocket_doctor"); 
        ?>

 
<!--28 feb Medicine Disple After storing in DataBase-->
...
?>
        <tr>
            ...
            <td><img src="DOLO.jpg" height="100" alt="ttt"></td>
            <td>
                 <a href="admin_update.php?edit=<?php echo $row['id']; ?>" class="btn"> <i class="fas fa-edit"></i>edit</a>
                 <a href="admin_update.php?delete=<?php echo $row['id'];?>" class="btn"><i class="fas fa-edit"></i>delete</a>
        </td>

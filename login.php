            ...
            <form method="post" onsubmit="return login()">
                ...
                <div class="passwordlogo">
                 ...
                 <div class="password-container" style="display:flex;">
                    ...
                    <i class="fa-solid fa-eye-slash" id="closed-eye" style="cursor:pointer;padding-top:0.6rem; margin-left: -10%;
    font-weight: 900;"></i>
                    <i class="fa-solid fa-eye" id="open-eye" style="cursor:pointer;display:none;padding-top:0.6rem; margin-left: -10%;
    font-weight: 900;"></i>
                </div>
